...
estimated_dists = {zt_strength: np.zeros((nruns, 2)) for zt_strength in zt_strengths}
...
for zt_strength in zt_strengths:
    ...
    for r_ix in trange(nruns):
        ...
        # === SAVE RESULTS ===
        estimated_source_probs[zt_strength][r_ix] = res["source_probs"]
        estimated_mtes[zt_strength][r_ix] = res["means"]
        estimated_dists[zt_strength][r_ix] = None
...
results = dict(
    ...
    estimated_dists=estimated_dists,
)
